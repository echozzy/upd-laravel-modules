...
class ModelMakeCommand extends GeneratorCommand
{
    ...
    /**
     * Create a proper Factory name:
     * ProductDetail: product_details
     * Product: products
     * @return string
     */
    private function createFactoryName()
    {
    ...
    private function handleOptionalFactoryOption()
    {
        if ($this->option('factory') === true) {
            $factoryName = $this->createFactoryName().'Factory';
            $this->call('module:make-factory', ['name' => $factoryName, 'module' => $this->argument('module')]);
        }
    }
